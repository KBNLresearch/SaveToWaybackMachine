...
inputworkfile="Input-Literatuurplein_GearchiveerdeURLs_21112019_werkbestand.txt"
outputworkfile="Output-Literatuurplein_GearchiveerdeURLs_21112019_werkbestand.txt"
outputerrorfile="Output-Literatuurplein_GearchiveerdeURLs_21112019_errors.txt"
...
with open(outputworkfile, "w") as outputfile: # open new versin of outputfile, clear the old version
    ...
    for url in urllist:
        time.sleep(15)  # pause for 5 sec, not to overrequest the server. Choose longer times for archiving pdf and doc files, as the archiving software needs more time to read these docs than standard html pages
